...
class LocalizedNames {
  ...
  /// Локализованные **значения** (смысл) сур 1..114 для русского языка.
  /// Используются на экране выбора суры под её названием
  /// (например, «Корова» для Аль-Бакара). Списки названий сур
  /// (транслитерации) лежат в ARB-файлах; здесь только краткие
  /// переводы-пересказы, принятые в русскоязычной исламской
  /// традиции.
  static const surahMeaningRu = <int, String>{
    1: 'Открывающая Книгу', 2: 'Корова', 3: 'Семейство Имрана',
    4: 'Женщины', 5: 'Трапеза', 6: 'Скот', 7: 'Преграды',
    8: 'Трофеи', 9: 'Покаяние', 10: 'Юнус', 11: 'Худ',
    12: 'Юсуф', 13: 'Гром', 14: 'Ибрахим', 15: 'Аль-Хиджр',
    16: 'Пчёлы', 17: 'Ночной перенос', 18: 'Пещера',
    19: 'Марьям', 20: 'Та Ха', 21: 'Пророки', 22: 'Паломничество',
    23: 'Верующие', 24: 'Свет', 25: 'Различение', 26: 'Поэты',
    27: 'Муравьи', 28: 'Повествование', 29: 'Паук', 30: 'Римляне',
    31: 'Лукман', 32: 'Поклон', 33: 'Сонмы', 34: 'Саба',
    35: 'Творец', 36: 'Йа Син', 37: 'Выстроившиеся в ряды',
    38: 'Буква Сад', 39: 'Толпы', 40: 'Прощающий', 41: 'Разъяснены',
    42: 'Совет', 43: 'Украшения', 44: 'Дым', 45: 'Коленопреклонённые',
    46: 'Пески', 47: 'Мухаммед', 48: 'Победа', 49: 'Комнаты',
    50: 'Буква Каф', 51: 'Рассеивающие', 52: 'Гора', 53: 'Звезда',
    54: 'Месяц', 55: 'Милостивый', 56: 'Падающее', 57: 'Железо',
    58: 'Препирающаяся', 59: 'Собрание', 60: 'Испытуемая',
    61: 'Ряды', 62: 'День пятничной молитвы', 63: 'Лицемеры',
    64: 'Раскрытие самообмана', 65: 'Развод', 66: 'Запрещение',
    67: 'Власть', 68: 'Письменная трость', 69: 'Неминуемое',
    70: 'Ступени', 71: 'Нух', 72: 'Джинны',
    73: 'Закутавшийся', 74: 'Завернувшийся', 75: 'Воскресение',
    76: 'Человек', 77: 'Посылаемые', 78: 'Весть',
    79: 'Исторгающие', 80: 'Нахмурился', 81: 'Скручивание',
    82: 'Раскалывание', 83: 'Обвешивающие',
    84: 'Разверзнется', 85: 'Созвездия', 86: 'Ночной путник',
    87: 'Высочайший', 88: 'Покрывающее', 89: 'Заря',
    90: 'Город', 91: 'Солнце', 92: 'Ночь', 93: 'Утро',
    94: 'Раскрытие', 95: 'Смоковница', 96: 'Сгусток',
    97: 'Предопределение', 98: 'Ясное знамение', 99: 'Землетрясение',
    100: 'Скачущие', 101: 'Великое бедствие', 102: 'Приумножение',
    103: 'Время', 104: 'Хулитель', 105: 'Слон', 106: 'Курайшиты',
    107: 'Милостыня', 108: 'Каусар', 109: 'Неверующие',
    110: 'Помощь', 111: 'Пальмовые волокна', 112: 'Искренность',
    113: 'Рассвет', 114: 'Люди',
  };

  /// Краткое значение (смысл) суры на языке [locale]. Для русского
  /// берёт из [surahMeaningRu], для английского — из [surahEn]
  /// (там эти строки изначально и являются смыслами, а не
  /// транслитерациями). Для всех остальных локалей возвращает `null`
  /// — UI скрывает строку.
  static String? surahMeaning(int id, Locale? locale) {
    if (id < 1 || id > 114) return null;
    if (locale?.languageCode == 'ru') return surahMeaningRu[id];
    if (locale?.languageCode == 'en') return surahEn[id];
    return null;
  }

  /// Кириллическая транслитерация названий сур 1..114
  /// («Аль-Фатиха», «Аль-Бакара», …).
  ///
  /// Используется как **универсальный fallback** в поиске по
  /// списку сур: даже если интерфейс переключён на `en` или `ar`,
  /// пользователь может набрать кириллицей и найти нужную суру
  /// по её русскому написанию. В ARB (`surahName{id}` для
  /// локали `ru`) лежат те же значения; здесь держим копию,
  /// чтобы поиск мог работать **без** `BuildContext` (например,
  /// в unit-тестах и сервисах).
  static const surahTransliterationRu = <int, String>{
    1: 'Аль-Фатиха', 2: 'Аль-Бакара', 3: 'Аль Имран',
    4: 'Ан-Ниса', 5: 'Аль-Маида', 6: 'Аль-Анам',
    7: 'Аль-Араф', 8: 'Аль-Анфаль', 9: 'Ат-Тауба', 10: 'Йунус',
    11: 'Худ', 12: 'Йусуф', 13: 'Ар-Раад', 14: 'Ибрахим',
    15: 'Аль-Хиджр', 16: 'Ан-Нахль', 17: 'Аль-Исра',
    18: 'Аль-Кахф', 19: 'Марьям', 20: 'Та Ха', 21: 'Аль-Анбийа',
    22: 'Аль-Хадж', 23: 'Аль-Муминун', 24: 'Ан-Нур',
    25: 'Аль-Фуркан', 26: 'Аш-Шуара', 27: 'Ан-Намль',
    28: 'Аль-Касас', 29: 'Аль-Анкабут', 30: 'Ар-Рум',
    31: 'Лукман', 32: 'Ас-Саджда', 33: 'Аль-Ахзаб', 34: 'Саба',
    35: 'Фатыр', 36: 'Йа Син', 37: 'Ас-Саффат', 38: 'Сад',
    39: 'Аз-Зумар', 40: 'Гафир', 41: 'Фуссилат',
    42: 'Аш-Шура', 43: 'Аз-Зухруф', 44: 'Ад-Духан',
    45: 'Аль-Джасийа', 46: 'Аль-Ахкаф', 47: 'Мухаммад',
    48: 'Аль-Фатх', 49: 'Аль-Худжурат', 50: 'Каф',
    51: 'Аз-Зарийат', 52: 'Ат-Тур', 53: 'Ан-Наджм',
    54: 'Аль-Камар', 55: 'Ар-Рахман', 56: 'Аль-Вакиа',
    57: 'Аль-Хадид', 58: 'Аль-Муджадила', 59: 'Аль-Хашр',
    60: 'Аль-Мумтахана', 61: 'Ас-Сафф', 62: 'Аль-Джумуа',
    63: 'Аль-Мунафикун', 64: 'Ат-Тагабун', 65: 'Ат-Талак',
    66: 'Ат-Тахрим', 67: 'Аль-Мульк', 68: 'Аль-Калам',
    69: 'Аль-Хакка', 70: 'Аль-Мааридж', 71: 'Нух',
    72: 'Аль-Джинн', 73: 'Аль-Муззаммиль',
    74: 'Аль-Муддассир', 75: 'Аль-Кийама', 76: 'Аль-Инсан',
    77: 'Аль-Мурсалят', 78: 'Ан-Наба', 79: 'Ан-Назиат',
    80: 'Абаса', 81: 'Ат-Таквир', 82: 'Аль-Инфитар',
    83: 'Аль-Мутаффифин', 84: 'Аль-Иншикак', 85: 'Аль-Бурудж',
    86: 'Ат-Тарик', 87: 'Аль-Аля', 88: 'Аль-Гашийа',
    89: 'Аль-Фаджр', 90: 'Аль-Балад', 91: 'Аш-Шамс',
    92: 'Аль-Лайл', 93: 'Ад-Духа', 94: 'Аш-Шарх',
    95: 'Ат-Тин', 96: 'Аль-Алак', 97: 'Аль-Кадр',
    98: 'Аль-Баййина', 99: 'Аз-Залзала', 100: 'Аль-Адийат',
    101: 'Аль-Кариа', 102: 'Ат-Такасур', 103: 'Аль-Аср',
    104: 'Аль-Хумаза', 105: 'Аль-Филь', 106: 'Курейш',
    107: 'Аль-Маун', 108: 'Аль-Каусар', 109: 'Аль-Кафирун',
    110: 'Ан-Наср', 111: 'Аль-Масад', 112: 'Аль-Ихлас',
